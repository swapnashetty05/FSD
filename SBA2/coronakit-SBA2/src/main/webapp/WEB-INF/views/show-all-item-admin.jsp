	...
	<div class="alert bg-light" style="margin: 10px;">
		...
		<c:choose>
			<c:when test="${productlist == null || productlist.isEmpty() }">
				<p class="well">No Products Available in Corona-Kit.</p>
			</c:when>
			<c:otherwise>
				<p class="font-weight-bold text-info" style="float: center;">
		<h5>Products available in Corona-Kit</h5>
		</p>
				</br>
				<table class="table table-sm">
					...
					<c:forEach items="${productlist}" var="product">
						<tr>
							...
							<td><a
								href="${pageContext.request.contextPath }/admin/product-delete?productId=${product.id}"><svg
