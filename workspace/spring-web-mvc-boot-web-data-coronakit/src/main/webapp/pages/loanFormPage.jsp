...
<body>
	...
	<form:form action="${isNew?pageContext.request.contextPath.concat('/admin/addLoan'):pageContext.request.contextPath.concat('/admin/saveLoan') }" method="post" modelAttribute="loan">
